...
public class Main {
    ...
    public static void main(String[] args) {
        IDiscordClient client = Example.createClient("NDc4ODcyODI4ODA5MzE0MzE0.DlRStw.Lq3qU377gySTPzV01Fn-l_PBeMo", true); // Gets the client object (from the first example)
